...
KEEP_FIELDS = [
    "@uniquename", "@namelocatag", "@uisprite", "@shopcategory", "@shopsubcategory1", "@shopsubcategory2", "@shopsubcategory3", "@craftingcategory", "@resourcetype",
    ...
    "grownitem", "consumption", "products", "@unlockedtoplace", "@unlockedtocraft", "craftingspelllist", "mountspelllist", "@transformation"
]
